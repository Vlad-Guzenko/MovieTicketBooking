            ...
            do
            {
                ...
                switch (keyInfo.Key)
                {
                    ...
                    case ConsoleKey.NumPad4:
                        new CancelBookScenario(movieRepository, bookingRepository, uiHelper).Run();
                        break;
